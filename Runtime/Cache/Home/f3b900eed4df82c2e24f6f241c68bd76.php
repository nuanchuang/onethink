...
<div class="container-fluid">
    ...
    <?php if(is_array($documents)): $i = 0; $__LIST__ = $documents;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$documents): $mod = ($i % 2 );++$i;?><div class="row noticeList">
            <a href="<?php echo U('index/service_detail');?>">
                <div class="col-xs-2">
    ...
    <?php if(empty($documents)): ?><td class="text-center"> aOh! 暂时还没有内容! </td><?php endif; ?>
    <div class="text-center">
        <input type="button" class="btn btn-info " value="获取更多~">
    </div>
